...
from employee.employeeApp import employeeInformation
...
class LuisConnect(ActivityHandler):
    ...
    async def on_message_activity(self,turn_context:TurnContext):
        ...
        emp = emp_info.get_employee_info(json_str.get('entity'))

        self.log.write_log(sessionID='session1',log_message="Bot Says: "+str(emp))
        await turn_context.send_activity(f"{emp}")